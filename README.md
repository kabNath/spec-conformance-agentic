...
| **Vidimus** | Calibrated confidence + Ed25519-signed attestation (sidecar) | implemented — uses [kabNath/vidimus](https://github.com/kabNath/vidimus) (bootstrap CI, RFC 8785, Ed25519) |
